...
function createAdmin($request_values){
	...
	$username = mysqli_real_escape_string($request_values['username']);
	$email = mysqli_real_escape_string($request_values['email']);
	$password = mysqli_real_escape_string($request_values['password']);
	$passwordConfirmation = mysqli_real_escape_string($request_values['passwordConfirmation']);

	if(isset($request_values['role'])){
		$role = mysqli_real_escape_string($request_values['role']);
	}
...
function createTopic($request_values){
	global $db, $errors, $topic_name;
		$topic_name = mysqli_real_escape_string($db,$db,$request_values['topic_name']);
...
function updateTopic($request_values) {
	...
	$topic_name = mysqli_real_escape_string($db,$request_values['topic_name']);
	$topic_id = mysqli_real_escape_string($db,$request_values['topic_id']);
	// create slug: if topic is "Life Advice", return "life-advice" as slug
	$topic_slug = makeSlug($topic_name);
	// validate form
	if (empty($topic_name)) {
